...
export const assets = {
  ...
  AAVE_E_AVAX: {
    ...
    nativeAsset: "AVAX",
    decimals: 18,
    explorerUrl: "cchain.explorer.avax.network",
  },
  AAVE_POLYGON: {
    id: "AAVE_POLYGON",
    name: "Aave (Polygon)",
  ...
  ACM_SOL: {
    ...
    explorerUrl: "explorer.solana.com",
  },
  ADA: {
    id: "ADA",
    name: "ADA (Cardano)",
  ...
  ADA_TEST: {
    ...
    decimals: 6,
    explorerUrl: "preprod.cardanoscan.io",
  },
  ADAI: {
    id: "ADAI",
  ...
  ALGO_TEST: {
    ...
    decimals: 6,
    explorerUrl: "testnet.algoexplorer.io",
  },
  ALGO_USDC_2V6G: {
    id: "ALGO_USDC_2V6G",
  ...
  ATOM_COS: {
    ...
    decimals: 6,
    explorerUrl: "bigdipper.live/cosmos",
  },
  ATOM_COS_TEST: {
    id: "ATOM_COS_TEST",
    ...
    decimals: 6,
    explorerUrl: "explorer.theta-testnet.polypore.xyz",
  },
  ATRI: {
    id: "ATRI",
    name: "AtariToken",
  ...
  AURORA_DEV: {
    ...
    decimals: 18,
    explorerUrl: "explorer.testnet.aurora.dev",
  },
  AUSDC: {
    id: "AUSDC",
  ...
  AVAXTEST: {
    ...
    decimals: 18,
    explorerUrl: "subnets-test.avax.network",
  },
  AVUSDC: {
    id: "AVUSDC",
  ...
  AXIE_RON: {
    ...
    nativeAsset: "RON",
    decimals: 0,
    explorerUrl: "explorer.roninchain.com",
  },
  AXS: {
    id: "AXS",
  ...
  BCH: {
    ...
    nativeAsset: "BCH",
    decimals: 8,
    explorerUrl: "blockexplorer.one/bitcoin-cash/mainnet",
  },
  BCH_BSC: {
    id: "BCH_BSC",
  ...
  BCH_TEST: {
    ...
    decimals: 8,
    explorerUrl: "blockexplorer.one/bitcoin-cash/testnet",
  },
  BCP: {
    id: "BCP",
  ...
  BNB_TEST: {
    ...
    decimals: 18,
    explorerUrl: "testnet.bscscan.com",
  },
  BNT: {
    id: "BNT",
    name: "Bancor",
  ...
  BSV_TEST: {
    ...
    decimals: 8,
    explorerUrl: "test.whatsonchain.com",
  },
  BTC: {
    id: "BTC",
    name: "Bitcoin",
  ...
  BTC_TEST: {
    ...
    decimals: 8,
    explorerUrl: "blockstream.info/testnet",
  },
  BTCB_BSC: {
    id: "BTCB_BSC",
  ...
  DASH: {
    ...
    nativeAsset: "DASH",
    decimals: 8,
    explorerUrl: "blockexplorer.one/dash/mainnet",
  },
  DASH_TEST: {
    id: "DASH_TEST",
    name: "Dash Test",
    ...
    decimals: 8,
    explorerUrl: "blockexplorer.one/dash/testnet",
  },
  DATA: {
    id: "DATA",
    name: "Streamr Data",
  ...
  DOGE: {
    ...
    nativeAsset: "DOGE",
    decimals: 8,
    explorerUrl: "dexplorer.dogechain.dog",
  },
  DOGE_BSC: {
    id: "DOGE_BSC",
  ...
  DOT: {
    ...
    nativeAsset: "DOT",
    decimals: 10,
    explorerUrl: "explorer.polkascan.io/polkadot",
  },
  DOT_BSC: {
    id: "DOT_BSC",
  ...
  ETC: {
    ...
    nativeAsset: "ETC",
    decimals: 18,
    explorerUrl: "blockscout.com/etc/mainnet",
  },
  ETC_TEST: {
    id: "ETC_TEST",
    ...
    decimals: 18,
    explorerUrl: "blockscout.com/etc/kotti",
  },
  ETH: {
    id: "ETH",
    name: "Ethereum",
  ...
  "ETH-AETH_RIN": {
    ...
    decimals: 18,
    explorerUrl: "testnet.arbiscan.io",
  },
  "ETH-OPT": {
    id: "ETH-OPT",
  ...
  ETHW: {
    ...
    nativeAsset: "ETHW",
    decimals: 18,
    explorerUrl: "www.oklink.com/ethw",
  },
  ETRY: {
    id: "ETRY",
    name: "FX-T0 eTRY",
  ...
  EVMOS: {
    ...
    nativeAsset: "EVMOS",
    decimals: 18,
    explorerUrl: "bigdipper.live/evmos",
  },
  EVN: {
    id: "EVN",
    name: "Evn Token",
  ...
  HBAR: {
    ...
    nativeAsset: "HBAR",
    decimals: 8,
    explorerUrl: "explorer.arkhia.io/#/mainnet",
  },
  HBAR_TEST: {
    id: "HBAR_TEST",
    ...
    decimals: 8,
    explorerUrl: "explorer.arkhia.io/#/testnet",
  },
  HBB_SPL: {
    id: "HBB_SPL",
  ...
  KSM: {
    ...
    nativeAsset: "KSM",
    decimals: 12,
    explorerUrl: "explorer.polkascan.io/kusama",
  },
  KSM_BSC: {
    id: "KSM_BSC",
    name: "Kusama (BSC)",
  ...
  LTC: {
    ...
    nativeAsset: "LTC",
    decimals: 8,
    explorerUrl: "blockexplorer.one/litecoin/mainnet",
  },
  LTC_BSC: {
    id: "LTC_BSC",
  ...
  LTC_TEST: {
    ...
    decimals: 8,
    explorerUrl: "blockexplorer.one/litecoin/testnet",
  },
  LTO: {
    id: "LTO",
  ...
  LUNA: {
    ...
    nativeAsset: "LUNA",
    decimals: 6,
    explorerUrl: "finder.terra.money/classic",
  },
  LUNA2: {
    id: "LUNA2",
    name: "Terra Luna 2.0",
    ...
    nativeAsset: "LUNA2",
    decimals: 6,
    explorerUrl: "finder.terra.money",
  },
  LUNA2_TEST: {
    id: "LUNA2_TEST",
    ...
    decimals: 6,
    explorerUrl: "finder.terra.money/testnet",
  },
  LUSD: {
    id: "LUSD",
  ...
  MOVR_MOVR: {
    ...
    decimals: 18,
    explorerUrl: "moonriver.moonscan.io",
  },
  MPL: {
    id: "MPL",
    name: "Maple Token",
  ...
  NEAR_TEST: {
    ...
    decimals: 24,
    explorerUrl: "explorer.testnet.near.org",
  },
  NEC: {
    id: "NEC",
  ...
  RBTC_TEST: {
    ...
    decimals: 18,
    explorerUrl: "explorer.testnet.rsk.co",
  },
  RCN: {
    id: "RCN",
  ...
  TAB1_XLM_OXFD_YK4G: {
    ...
    explorerUrl: "testnet.stellarchain.io",
  },
  TALEB_SOL_TEST: {
    id: "TALEB_SOL_TEST",
  ...
  TRX_TEST: {
    ...
    decimals: 6,
    explorerUrl: "shasta.tronscan.org",
  },
  TRX_USDC_6NU3: {
    id: "TRX_USDC_6NU3",
    name: "USD Coin (Tron)",
  ...
  WND: {
    ...
    nativeAsset: "WND",
    decimals: 12,
    explorerUrl: "westend.subscan.io",
  },
  WNXM: {
    id: "WNXM",
    name: "Wrapped NXM",
  ...
  XEC: {
    ...
    nativeAsset: "XEC",
    decimals: 2,
    explorerUrl: "explorer.bitcoinabc.org",
  },
  XEC_TEST: {
    id: "XEC_TEST",
    name: "eCash Test",
    ...
    decimals: 2,
    explorerUrl: "texplorer.bitcoinabc.org",
  },
  XEM: {
    id: "XEM",
    name: "XEM",
    ...
    nativeAsset: "XEM",
    decimals: 6,
    explorerUrl: "explorer.nemtool.com",
  },
  XEM_TEST: {
    id: "XEM_TEST",
    name: "XEM Test",
    ...
    decimals: 6,
    explorerUrl: "testnet-explorer.nemtool.com",
  },
  XFIT: {
    id: "XFIT",
    name: "XFIT",
  ...
  ZEC_TEST: {
    ...
    decimals: 8,
    explorerUrl: "explorer.testnet.z.cash",
  },
  ZERO: {
    id: "ZERO",
