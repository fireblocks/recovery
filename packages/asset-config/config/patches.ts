...
export const nativeAssetPatches: NativeAssetPatches = {
  ...
  'ETH-AETH_SEPOLIA': evm('sepolia.arbiscan.io'),
  'ETH-OPT': evm('optimistic.etherscan.io'),
  'ETH-OPT_KOV': evm('kovan-optimistic.etherscan.io'),
  'ETH-OPT_SEPOLIA': evm('sepolia-optimism.etherscan.io'),
  BASECHAIN_ETH: evm('basescan.org', 'https://mainnet.base.org'),
  BASECHAIN_ETH_TEST5: evm('sepolia.basescan.org', 'https://sepolia.base.org'),
  ETH_ZKSYNC_ERA: evm('explorer.zksync.io', 'https://mainnet.era.zksync.io'),
  ETH_ZKSYNC_ERA_SEPOLIA: evm('sepolia.explorer.zksync.io', 'https://sepolia.era.zksync.dev'),
  ETH_ZKSYNC_ERA_TEST: evm('goerli.explorer.zksync.io', 'https://testnet.era.zksync.dev'),
  ETH_ZKEVM_TEST: evm('cardona-zkevm.polygonscan.com/', 'https://rpc.public.zkevm-test.net'),
  LINEA_TEST: evm('sepolia.lineascan.build', 'https://rpc.goerli.linea.build'),
  LINEA_SEPOLIA_TEST: evm('sepolia.lineascan.build', 'https://rpc.sepolia.linea.build'),
  SCROLL_SEPOLIA_TEST: evm('sepolia.scrollscan.com', 'https://sepolia-rpc.scroll.io'),
  WORLDCHAIN_TEST: evm('worldchain-sepolia.explorer.alchemy.com', 'https://worldchain-sepolia.g.alchemy.com/public'),
