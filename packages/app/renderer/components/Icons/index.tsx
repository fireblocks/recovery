...
export const VaultAccountIcon = (props: SvgIconProps) => (
...
export const DepositAddressesIcon = ({ active, ...props }: Props) => (
...
export const KeyIcon = ({ active, ...props }: Props) => (
...
export const WithdrawIcon = ({ active, ...props }: Props) => (
  <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 21" {...props}>
    <g fill={active ? theme.palette.primary.main : "currentColor"}>
      <path
        d="M1.875 10.5a8.125 8.125 0 0 0 16.25 0h1.25a9.375 9.375 0 1 1-18.75 0h1.25Z"
        opacity=".407"
      />
