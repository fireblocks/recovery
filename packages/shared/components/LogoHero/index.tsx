...
export function LogoHero({ title, description, icon: Icon = Restore, ...props }: Props) {
  return (
    <Box {...props}>
      ...
      <Box display='flex' alignItems='center' marginBottom='1rem'>
        <Typography component='div' variant='h1' fontSize='30px' position='relative' left='-4px' margin='0 2px 0 0'>
