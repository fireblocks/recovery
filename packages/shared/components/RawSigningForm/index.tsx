...
import { Button, getDerivationMapKey, getLogger, Select, TextField, VaultAccount } from '@fireblocks/recovery-shared';
import { ExtendedKeys, HDPath } from '@fireblocks/wallet-derivation';
...
const RawSigningForm: React.FC<RawSigningFormProps> = (props) => {
  const { extendedKeys, accounts } = props;
