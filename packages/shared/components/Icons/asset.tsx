...
export const rootProps = (width = 24, height = 24): Omit<SvgIconProps, 'width' | 'height'> => ({
...
const iconDataMap: Record<string, IconData> = {
  BTC: {
...
export function AssetIcon({ assetId, ...props }: Props) {
  const iconData = assetId ? iconDataMap[assetId as keyof typeof iconDataMap] : undefined;
